...
const ExternalTrainingCostReport = () => {
  ...
  const fetchReport = (e) => {
    ...
    axios
      .get(`http://127.0.0.1:8000/api/external/report/cost/${value}/${year}`)
      .then((response) => {
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-8">
              <h1>EXTERNAL TRAINING COST REPORT (QUATERLY)</h1>
            </div>
...
export default ExternalTrainingCostReport;
